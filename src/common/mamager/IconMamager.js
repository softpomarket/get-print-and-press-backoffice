const MdChangeCircle = (props) => {
    return (
        <svg
            style={props.type === 1 ? { height: 23, width: 23, color: 'orange', marginBottom: 5 } : { height: 23, width: 23, color: 'orange' }}
            stroke="currentColor"
            fill="currentColor"
            stroke-width="0"
            viewBox="0 0 24 24"
