...
// Property Type
const insertPropertyTypesFetch = async (param, body, accessToken) => {
  // Done
  try {
    const result = await httpClient.post(
      server.INSERT_PROPERTY_TYPES_URL,
      body,
      {
        headers: {
...
const getPropertyTypesFetch = async (param, body, accessToken) => {
  // Done
  try {
    const result = await httpClient.get(
      server.GET_PROPERTY_TYPES_URL +
...
const getPropertyTypesByIdFetch = async (param, body, accessToken) => {
  try {
    const result = await httpClient.get(
      server.GET_PROPERTY_TYPES_BY_ID_URL + `/${param.id}`,
      {
        headers: {
          "x-access-token": accessToken,
        },
...
const updatePropertyTypesFetch = async (param, body, accessToken) => {
  try {
    const result = await httpClient.put(
      server.UPDATE_PROPERTY_TYPES_URL + `/${param.id}`,
      body,
      {
        headers: {
          "x-access-token": accessToken,
...
const deletePropertyTypesByIdFetch = async (param, body, accessToken) => {
  try {
    const result = await httpClient.delete(
      server.DELETE_PROPERTY_TYPES_BY_ID_URL + `/${param.id}`,
      {
        headers: {
          "x-access-token": accessToken,
        },
